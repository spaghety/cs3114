...
public class HashTable {
	...
	/*
	 * This function doubles the size of the byte array in case it reaches max capacity.
	 */
	...
	/*
	 * This function removes entries from the hash table and will free space once fully implemented.
	 * @param id
