...
public class CommandHandler2Test extends TestCase {
    ...
    /**
     * Tests searchNumber(BSTree, int) and getter and setter for children nodes
     */
    public void testSearchNumber() {
        idRoot = new BSTree(sem, sem.id(), null);
        assertNull(ch.searchNumber(idRoot, 0));
        assertNull(idRoot.getLeft());
        assertNull(idRoot.getRight());
        assertEquals(sem, ch.searchNumber(idRoot, 2));
        idRoot.setRight(right);
        assertEquals(right, idRoot.getRight());
        assertEquals(sem3, ch.searchNumber(idRoot, 3));
        idRoot.setLeft(left);
        assertEquals(left, idRoot.getLeft());
        assertEquals(sem2.id(), ch.searchNumber(idRoot, 1).id());
    }
    ...
    /**
     * Tests searchNumRange(BSTree, int, int)
     */
    public void testSearchNumRange() {
        ...
        costRoot = ch.insertBST(costRoot, s2, s2.cost(), null);
        costRoot = ch.insertBST(costRoot, s3, s3.cost(), null);
        assertEquals(s1.toString() + "\n", ch.searchNumRange(costRoot, 10, 20));
        assertEquals(s1.toString() + "\n", ch.searchNumRange(costRoot, 15, 15));
        assertEquals(s2.toString() + "\n", ch.searchNumRange(costRoot, 20, 21));
        assertEquals(s3.toString() + "\n", ch.searchNumRange(costRoot, 5, 10));
        assertEquals((s3.toString() + "\n" + s1.toString() + "\n"), (ch
            .searchNumRange(costRoot, 5, 15)));
        assertEquals((s1.toString() + "\n" + s2.toString() + "\n"), (ch
            .searchNumRange(costRoot, 15, 21)));
        assertEquals((s3.toString() + "\n" + s1.toString() + "\n" + s2
            .toString() + "\n"), (ch.searchNumRange(costRoot, 5, 21)));
    }
