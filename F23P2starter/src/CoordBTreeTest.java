...
public class CoordBTreeTest extends TestCase {
    ...
    public void setUp() {
        ...
        sem = new Seminar(0, "example", "Oct30", 90, (short) 2, (short) 6, 23, tags, "Test description");
    }
    ...
    public void testInsertFalse() {
        Seminar falseSem = new Seminar(1, "test", "0", 10, (short) -1, (short) 4, 12, tags, "desc");
        Seminar falseSem2 = new Seminar(1, "test", "0", 10, (short) 128, (short) 6, 12, tags, "desc");
        Seminar falseSem3 = new Seminar(1, "test", "0", 10, (short) 2, (short) -1, 12, tags, "desc");
        Seminar falseSem4 = new Seminar(1, "test", "0", 10, (short) 2, (short) 128, 12, tags, "desc");
...
// System.setOut(stream);
        String content = "";
        String result = "";
        Seminar trueSem = new Seminar(1, "example", "Oct30", 90, (short) 2, (short) 2, 2, tags, "Test description");
        Seminar trueSem2 = new Seminar(2, "example", "Oct30", 90, (short) 2, (short) 1, 2, tags, "Test description");
        Seminar trueSem2Same = new Seminar(12, "example", "Oct30", 90, (short) 2, (short) 1, 2, tags,
                "Test description");
        Seminar trueSem3 = new Seminar(3, "example", "Oct30", 90, (short) 6, (short) 1, 7, tags, "Test description");
        Seminar trueSem4 = new Seminar(4, "example", "Oct30", 90, (short) 6, (short) 7, 7, tags, "Test description");
        Seminar trueSem5 = new Seminar(5, "example", "Oct30", 90, (short) 6, (short) 0, 7, tags, "Test description");
        Seminar trueSem6 = new Seminar(6, "example", "Oct30", 90, (short) 7, (short) 0, 7, tags, "Test description");
...
// System.out.println(bt.toString());
    ...
    public void testRemove() {
        Seminar sem1 = new Seminar(1, "example", "Oct30", 90, (short) 2, (short) 2, 2, tags, "Test description");
        Seminar sem2 = new Seminar(3, "example", "Oct30", 90, (short) 2, (short) 6, 6, tags, "Test description");
        Seminar sem3 = new Seminar(4, "example", "Oct30", 90, (short) 4, (short) 6, 6, tags, "Test description");
        Seminar sem4 = new Seminar(5, "example", "Oct30", 90, (short) 6, (short) 2, 6, tags, "Test description");
        bt.insert(sem);
